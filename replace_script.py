...
# The new HTML block
new_html = """<!-- Về Chúng Tôi - Vì sao chọn -->
        ...
        <div class="container">
            ...
            <div class="materials-gallery" style="margin-bottom: 60px;">
                ...
                <div class="gallery-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                    <div style="aspect-ratio: 4/3; background: #ddd; border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #888;">Ảnh Vietbuild 1</div>
                    <div style="aspect-ratio: 4/3; background: #ddd; border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #888;">Ảnh Vietbuild 2</div>
                    <div style="aspect-ratio: 4/3; background: #ddd; border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #888;">Ảnh Vietbuild 3</div>
                    <div style="aspect-ratio: 4/3; background: #ddd; border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #888;">Ảnh Vietbuild 4</div>
                </div>
            </div>
            ...
            <div class="production-technology" style="display: flex; flex-wrap: wrap; gap: 40px; align-items: center;">
                <div class="tech-content" style="flex: 1; min-width: 300px;">
                    ...
                    <a href="#" class="btn btn-outline-danger btn-pill">TÌM HIỂU CÔNG NGHỆ &nbsp;<i class="fa-solid fa-arrow-right-long"></i></a>
                </div>
                <div class="tech-images" style="flex: 1; min-width: 300px; position: relative;">
                    <img src="images/factory-video.jpg" alt="Nhà máy Mividoor" style="width: 100%; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.15); object-fit: cover; aspect-ratio: 4/3;">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="pvc-collection" style="padding: 60px 0;">
        <div class="container">
            ...
            <div class="colors-grid" id="pvc-colors-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 20px;">
    ...
    <section id="san-pham" class="products-section" style="padding: 80px 0; background-color: var(--light-bg);">
        <div class="container">
            ...
            <div class="collection-grid" id="product-grid">
                <!-- Products will be generated by JS to keep HTML clean -->
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="luxury-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
                <div class="luxury-card" style="position: relative; overflow: hidden; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); aspect-ratio: 3/4; background: #eee;">
                    <div style="position: absolute; top:0; left:0; width:100%; height:100%; display:flex; align-items:center; justify-content:center; color:#999;">Ảnh Mẫu Luxury 1</div>
                ...
                <div class="luxury-card" style="position: relative; overflow: hidden; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); aspect-ratio: 3/4; background: #eee;">
                    <div style="position: absolute; top:0; left:0; width:100%; height:100%; display:flex; align-items:center; justify-content:center; color:#999;">Ảnh Mẫu Luxury 2</div>
                    <div class="luxury-info" style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.8)); padding: 40px 20px 20px; color: white;">
                ...
                <div class="luxury-card" style="position: relative; overflow: hidden; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.1); aspect-ratio: 3/4; background: #eee;">
                    <div style="position: absolute; top:0; left:0; width:100%; height:100%; display:flex; align-items:center; justify-content:center; color:#999;">Ảnh Mẫu Luxury 3</div>
                    <div class="luxury-info" style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.8)); padding: 40px 20px 20px; color: white;">
